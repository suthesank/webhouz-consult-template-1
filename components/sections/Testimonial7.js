                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 m-auto">
                            <div className="tsetimonial7-textarea text-center margin-b60">
                                ...
                                <h1 className="font-lora font-44 lineh-52 weight-500 color-h7 margin-b20">Some Love Words From
                                    Clients</h1>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-lg-12" data-aos="fade-down" data-aos-duration={1000}>
                            <Swiper {...swiperOptions} className="testimonial7-carousel-area owl-carousel">
                                <SwiperSlide className="textimonial7-carousel">
                                    ...
                                    <p className="font-18 lineh-28 font-ks weight-500 color-h7 margin-b24 margin-t">“Business
                                        Consultant to legal entity filing, the marketing setup, automation, on the legal
                                        bookkeeping, technology, in person of an networking, online sales, permits and consult.
                                    </p>
                    ...
                    <div className="row">
                        <div className="col-lg-6 m-auto">
                            <div className="testimonial7-btnara text-center margin-t48">
                                <p className="font-ks font-16 weight-500 color-hp lineh-26">Explain your approach to mediation and
                                    arbitration for efficient conflict resolution. Introduce key members of your legal team,
                                    including.</p>
                                <div className="div" data-aos="fade-up" data-aos-duration={1200}>
                                    <Link href="/testimonials" className="font-ks font-16 weight-700 color lineh-16 shedulebtn3 margin-t32">Read More
                                        Testimonials</Link>
                                </div>
                            </div>
                        </div>
