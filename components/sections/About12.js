                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-8">
                            <div className="images-divided-area">
                                ...
                                <div className="aboutcounter-area aboutcounter2" data-aos="zoom-in" data-aos-easing="linear" data-aos-duration={600}>
                        ...
                        <div className="col-lg-4">
                            <div className="about-11-textarea" data-aos="fade-left" data-aos-duration={1000}>
                                <span className="font-outfit font-16 lineh-16 weight-600 color-h12 aroplan3 d-inline-block margin-b24"><img src="/assets/images/icons/aroplanicons3.svg" alt="" />About Us</span>
                                ...
                                <div className="about-three__content-btn" data-aos="fade-left" data-aos-duration={1000} data-aos-easing={800}>
                                    <Link href="/about" className="thm-btn thmbtn12 font-16 lineh-16 font-outfit weight-500 color margin-t32" data-text="Immigration Guidance">Immigration Guidance</Link>
                                </div>
                            </div>
                        </div>
                    </div>
