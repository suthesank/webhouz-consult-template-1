            ...
            <div className="testimonial11-scetion-area section-padding5">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 m-auto">
                            <div className="testimonial11-header text-center margin-b60">
                                <span className="font-outfit font-16 lineh-16 weight-500 color-h11 aropaln2 d-inline-block margin-b24"><img src="/assets/images/icons/aroplanicons2.svg" alt="" />Testimonials</span>
                    ...
                    <div className="col-lg-12" data-aos="fade-up" data-aos-duration={1000}>
                        <Swiper {...swiperOptions} className="testimonials11-owl-carousel owl-carousel">
                            <SwiperSlide className="testimonial-autor-area">
                                <div className="qutio1 margin-b">
                                    <img src="/assets/images/icons/quito7.svg" alt="" />
                                </div>
